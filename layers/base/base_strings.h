...
internal String8 push_str8_nt(Arena *arena, S64 length);
internal String8 push_str8_fill_byte_nt(Arena *arena, S64 length, U8 byte);
...
internal String8 str8_skip(String8 string, S64 amt);
internal String8 str8_chop(String8 string, S64 amt);
...
internal Vec2S64 str8_pos_from_offset(String8 string, S64 offset);
...
internal String8Node* str8_list_push_aligner(Arena *arena, String8List *list, S64 min, S64 align);
